...
export function Main() {
  return (
    <div className="w-full max-w-[90%] mx-auto 2xs:p-0.5 sm:p-2 md:pt-10 pb-4">
      ...
      {/*                     hover:from-pink-400 hover:via-fuchsia-400 hover:to-purple-400 transition-all duration-500`}>Renado</span>*/}
      {/*                </Link>*/}
      {/*            </p>*/}
      ...
      {/*            </Link>*/}
      {/*            <GithubIcon className={'size-5 hover:size-7 transition-all duration-300'}/>*/}
      {/*            <span>·</span>*/}
