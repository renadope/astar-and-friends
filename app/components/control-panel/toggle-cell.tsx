      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="2xs:hidden xs:block text-xs xs:text-gray-600 sm:text-gray-500">
        ...
        <div
          className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all duration-300 ${
            !hasNoAStarData
              ...
              : (selectionState[state.cellSelectionState] ??
                'bg-gray-100 text-gray-500 border border-gray-200')
          }`}
        >
          {!hasNoAStarData ? 'Locked' : phrase[state.cellSelectionState]}
        </div>
      </div>
              ...
              <div
                className={`absolute -inset-1
                             bg-pink-200 rounded-full opacity-0 group-data-[state=on]:opacity-30
                              group-data-[state=on]:animate-ping`}
              ></div>
            </div>
