...
export function CostWeightSliders({ className, ...props }: ComponentPropsWithoutRef<'div'>) {
  ...
  return (
    <div
      className={cn(
        'bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 p-6 space-y-6',
        className
      )}
      {...props}
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="2xs:hidden xs:block text-sm text-gray-500">
