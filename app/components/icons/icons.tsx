  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={2}
        d="M10 4h2v16h-2zM16 4h2v16h-2z"
      />
    </svg>
  );
}

export function ForwardIcon({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function PreviousIcon({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function FancyClickIcon({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
